...
A simulated enterprise identity and security operations environment built on Oracle Cloud Infrastructure, designed to demonstrate real-world Active Directory administration, identity lifecycle management, GPO governance, PowerShell automation, and security event monitoring.
